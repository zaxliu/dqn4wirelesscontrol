...
if __name__=='__main__':
    ...
    nodes = [Node(id=0, agent=agents[0], routing_childs=[None], parent=2, epoch=3, histLen=2, chanLen=channel_length),
            Node(id=1, agent=agents[1], routing_childs=[None], parent=2, epoch=3, histLen=2, chanLen=channel_length),
            Node(id=2, agent=agents[2], routing_childs=[0, 1], parent=None, epoch=10000, histLen=2, chanLen=channel_length)]
