...
adjust_offset, n_belief_bins = 1e-22, 5
max_queue_len = 20
...
traffic_params = (model_type, traffic_window_size, adjust_offset, n_belief_bins)
queue_params = (max_queue_len,)
reward_params = (Rs, Rw, Rf, Re)
env_model = SJTUModel(traffic_params, queue_params, reward_params)
